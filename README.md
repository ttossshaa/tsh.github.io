...
Для совершенствования кода рекомендуется:  
1. Добавить валидацию входных данных.  
2. Реализовать фабричный метод `from_input()` для улучшения структуры.  
3. Внедрить форматированный вывод с точностью до 5 знаков после запятой.
